...
public:
    ...
    int staff_age;
    PoultryFarm(std::string name = "", int age = 0)
...
class Staff : public PoultryFarm
{
public:
    int working_hours;
...
int main()
{
    ...
    work_day.staff_name = "Александр";
    work_day.working_hours = 10;

    cout << "Сегодня на смене: " << work_day.getName() << "\tРабочее время: " << work_day.working_hours << '\n';
