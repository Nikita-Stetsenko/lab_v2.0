...
private:
    ...
    int year;
public:
    PoultryFarm(int h = 0) : year(h)
    {
    }
    friend ostream& operator<< (ostream& out, const PoultryFarm& poultryfarm);
    friend istream& operator>> (std::istream& in, PoultryFarm& poultryfarm);
    PoultryFarm& operator= (const PoultryFarm& poultryfarm)
    {
        year = poultryfarm.year;
...
istream& operator>> (istream& in, PoultryFarm& poultryfarm)
{
    in >> poultryfarm.year;

    return in;
}
ostream& operator<< (ostream& out, const PoultryFarm& poultryfarm){
    out << "Year: " << poultryfarm.year <<  endl;
